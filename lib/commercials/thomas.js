...
VARIE tes accroches d'un post à l'autre : n'ouvre PAS systématiquement sur le
matin, la tasse de café, le coup de barre de 16h ou l'arrivée au bureau. Puise
dans des angles variés (une tendance du marché, une anecdote de visite, un détail
d'archi, une question, une observation sur le télétravail, la lumière, un quartier…).
`.trim(),
};
