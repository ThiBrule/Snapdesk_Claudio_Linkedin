...
export const COMMERCIALS = { ronan, cyril, melanie, florian, maxence, thomas, snapdesk };

// Liste ordonnée des clés (ronan, cyril, melanie, florian, maxence, thomas, snapdesk)
