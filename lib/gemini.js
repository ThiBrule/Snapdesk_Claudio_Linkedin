...
// Modèle par défaut : gemini-flash-lite-latest — alias "latest" (jamais retiré,
// contrairement aux versions figées), rapide, économique, sans "thinking".
// Surchargeable via la variable d'env MODEL (ex. gemini-flash-latest…).
export const MODEL = process.env.MODEL || 'gemini-flash-lite-latest';
