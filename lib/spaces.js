...
const HEADER_MAP = [
  ...
  { field: 'presentation',  keys: ['landing page', 'landingpage', 'lien landing page', 'landing', 'presentation de l espace', 'la presentation de l espace', 'presentation', 'preso', 'plaquette'] },
